...
export function ChatInterface({ applicationId, currentUserId, otherPartyName }: ChatInterfaceProps) {
    ...
    const handleSendMessage = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // First get the receiver_id from the application
            // This is a bit inefficient to do every time, but safe.
            // Ideally passed as prop, but for MVP this works.
            ...
            // Determine receiver
            const receiverId = currentUserId === appData.vendor_id ? eventData.host_id : appData.vendor_id;
