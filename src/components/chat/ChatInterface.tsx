...
interface ChatInterfaceProps {
    ...
    otherPartyImage?: string | null; // Optional profile image URL
}

export function ChatInterface({ applicationId, currentUserId, otherPartyName, otherPartyImage }: ChatInterfaceProps) {
